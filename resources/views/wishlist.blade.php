...
@section('styles')
<link href="{{ asset('css/user-account/bootstrap_account.css') }}" type="text/css" rel="stylesheet">
<link href="{{ asset('css/single-product/related-product-slider.css') }}" type="text/css" rel="stylesheet">
<link href="{{ asset('css/user-account/socialmedia-icons.css') }}" type="text/css" rel="stylesheet">
@endsection
